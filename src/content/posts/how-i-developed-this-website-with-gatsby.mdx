...
// Schema of the Gatsby Cloud and Netlify working together.

Netlify also offers a CMS service for those interested, but as stated before, given the diverse nature of components I inject (and will still inject) into my MDX files, I still prefer to manage it by hand.
...
As for a newsletter, I'm not making that kind of compromisse... Yet.
