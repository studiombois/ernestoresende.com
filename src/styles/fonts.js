...
const FontFaces = css`
  @font-face {
    ...
    src: url(${FuturaRegularWOFF2}) format('woff2'),
      url(${FuturaRegularWOFF}) format('woff');
    font-weight: 400;
    font-style: normal;
  }
  @font-face {
    font-family: 'Futura';
    src: url(${FuturaRegularItalicWOFF2}) format('woff2'),
      url(${FuturaRegularItalicWOFF}) format('woff');
    font-weight: 400;
    font-style: italic;
  }
  ...
  @font-face {
    ...
    src: url(${FuturaBlackWOFF2}) format('woff2'),
      url(${FuturaBlackWOFF}) format('woff');
    font-weight: 900;
    font-style: normal;
  }
  ...
  @font-face {
    ...
    src: url(${LeagueMonoRegularWOFF2}) format('woff2'),
      url(${LeagueMonoRegularWOFF}) format('woff');
    font-weight: 400;
    font-style: normal;
  }
  ...
  @font-face {
    ...
    src: url(${LeagueMonoBoldWOFF2}) format('woff2'),
      url(${LeagueMonoBoldWOFF}) format('woff');
    font-weight: 700;
    font-style: normal;
  }
  ...
  @font-face {
    ...
    src: url(${SrirachaRegularWOFF2}) format('woff2'),
      url(${SrirachaRegularWOFF}) format('woff');
    font-weight: 400;
    font-style: normal;
  }
`
